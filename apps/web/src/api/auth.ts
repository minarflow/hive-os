...
export type SetupStatus = { bootstrap_required: boolean; mode: string; hermes_profiles_root: string }
export const getSetupStatus = () => api<SetupStatus>('/api/setup/status')
export const bootstrap = (body: { username: string; password: string; profile_name: string; profile_slug: string }) =>
