...
export function Sidebar(props: {
  ...
  return <div className="sidebar-inner">
    <div className="sidebar-head"><div className="brand-row"><span className="brand-dot">H</span><strong>Hive OS</strong></div><div className="sidebar-actions"><button className="icon-button collapse-button" onClick={props.onToggleCollapse}>{props.collapsed ? '›' : '‹'}</button><button className="icon-button mobile-only" onClick={props.onClose}>×</button></div></div>
